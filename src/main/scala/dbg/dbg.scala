...
//      dbg_state_en    := io.dbg_cmd_valid | abstractcs_reg(10, 8).orR | ((command_reg(31, 24) === 0.U(8.W)) & !command_reg(17))
//      io.dbg_halt_req := (dmcontrol_wren_Q & dmcontrol_reg(31)).asBool()
//    }
...
//
//  abmem_addr_in_dccm_region := (abmem_addr(31,28) === DCCM_REGION.asUInt) & DCCM_ENABLE.asBool
//  abmem_addr_in_iccm_region := (abmem_addr(31,28) === ICCM_REGION.asUInt) & ICCM_ENABLE.asBool
//  abmem_addr_in_pic_region  := (abmem_addr(31,28) === PIC_REGION.asUInt)
//
//  io.dbg_cmd_addr   := Mux((command_reg(31, 24) === "h2".U), data1_reg, Cat(0.U(20.W), command_reg(11, 0)))
//  io.dbg_cmd_wrdata := data0_reg(31, 0)
//  io.dbg_cmd_valid  := (dbg_state === state_t.core_cmd_start) & !((abstractcs_reg(10,8).orR) | ((command_reg(31,24) === 0.U(8.W)) & !command_reg(17)) |
//    ((command_reg(31,24) === 2.U(8.W)) & abmem_addr_external)) & io.dma_dbg_ready
...
//
//  io.dbg_dma_bubble := ((dbg_state === state_t.core_cmd_start) & ~(abstractcs_reg(10, 8).orR) | (dbg_state === state_t.core_cmd_wait)).asBool()
//
...
//
//  io.sb_axi_awvalid   := sb_abmem_cmd_awvalid | sb_cmd_awvalid
//  io.sb_axi_awaddr    := sb_axi_addr
//  io.sb_axi_awid      := 0.U
//  io.sb_axi_awsize    := sb_axi_size
//  io.sb_axi_awprot    := 1.U(3.W)
//  io.sb_axi_awcache   := "b1111".U(4.W)
//  io.sb_axi_awregion  := sb_axi_addr(31, 28)
//  io.sb_axi_awlen     := 0.U
//  io.sb_axi_awburst   := "b01".U(2.W)
//  io.sb_axi_awqos     := 0.U
//  io.sb_axi_awlock    := false.B
//
//  io.sb_axi_wvalid  := sb_abmem_cmd_wvalid | sb_cmd_wvalid
//  io.sb_axi_wdata   := Fill(64, (sb_axi_size === 0.U(3.W))) & Fill(8, (sb_axi_wrdata(7, 0))) |
...
//
//  io.sb_axi_wstrb := Fill(8, (sb_axi_size === 0.U(3.W))) & ("h1".U(8.W) << sb_axi_addr(2, 0)) |
...
//  io.sb_axi_arvalid   := sb_abmem_cmd_arvalid | sb_cmd_arvalid
//  io.sb_axi_araddr    := sb_axi_addr
//  io.sb_axi_arid      := 0.U
//  io.sb_axi_arsize    := sb_axi_size
//  io.sb_axi_arprot    := 1.U(3.W)
//  io.sb_axi_arcache   := 0.U(4.W)
//  io.sb_axi_arregion  := sb_axi_addr(31, 28)
//  io.sb_axi_arlen     := 0.U
//  io.sb_axi_arburst   := 1.U(2.W)
//  io.sb_axi_arqos     := 0.U
...
//
//  sb_bus_rdata := Fill(64, (sb_axi_size === "h0".U)) & ((io.sb_axi_rdata(63, 0) >> 8.U * sb_axi_addr(2, 0)) & "hff".U(64.W)) |
//    Fill(64, (sb_axi_size === "h1".U)) & ((io.sb_axi_rdata(63, 0) >> 16.U * sb_axi_addr(2, 1)) & "hffff".U(64.W)) |
//    Fill(64, (sb_axi_size === "h2".U)) & ((io.sb_axi_rdata(63, 0) >> 32.U * sb_axi_addr(2)) & "hffff_ffff".U(64.W)) |
//    Fill(64, (sb_axi_size === "h3".U)) & io.sb_axi_rdata(63, 0)
//}
//
//// object debug extends App {
////   (new chisel3.stage.ChiselStage).emitVerilog(new quasar_dbg)
//// }
